...
if __name__ == '__main__':
	...
	with col1:
		...
		if uploaded_file is not None:
			...
			choice = -1
			if st.button(recipe['dashboard_image.jpg'][0]['title'], on_click=click):
				choice = 0
			elif st.button(recipe['dashboard_image.jpg'][1]['title']):
				choice = 1
			elif st.button(recipe['dashboard_image.jpg'][2]['title']):
				choice = 2
			elif st.button(recipe['dashboard_image.jpg'][3]['title']):
				choice = 3
			elif st.button(recipe['dashboard_image.jpg'][4]['title']):
				choice = 4
